...
# 30 regions — globally distributed for diverse carbon/cost optimization
REGIONS = [
    "us-east-1",
    "us-east-2",
    "us-west-1",
...
REGION_GEO: dict[str, dict[str, Any]] = {
    ...
    "us-central-1": {"lat": 41.9, "lon": -93.6, "label": "Iowa"},
    "ca-central-1": {"lat": 45.5, "lon": -73.6, "label": "Montreal"},
    "ca-west-1": {"lat": 51.0, "lon": -114.1, "label": "Calgary"},
    ...
    "eu-north-2": {"lat": 59.9, "lon": 10.7, "label": "Oslo"},
    ...
    "me-central-1": {"lat": 25.2, "lon": 55.3, "label": "Dubai"},
